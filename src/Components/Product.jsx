    ...
    >
      ...
      <Link to={`/product/${_id}`} className="block relative overflow-hidden">
        <div className="aspect-[4/3] relative">
          ...
          {/* Premium Badge */}
          <div className="absolute top-4 left-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-black text-xs font-bold px-3 py-1 rounded-full shadow-lg">
            PREMIUM
          </div>
      ...
      <div className="p-6 space-y-4">
        ...
        <Link
          to={`/product/${_id}`}
          className="block w-full mt-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-black font-bold py-3 rounded-xl text-center shadow-lg hover:shadow-cyan-500/70 transform hover:scale-105 transition-all duration-300"
        >
          View Details
        </Link>
      </div>
